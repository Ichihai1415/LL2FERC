...
namespace LL2FERC
{
    public partial class LL2FERC
    {
        ...
        {
            /// <summary>
            /// List of English names. [code, English name]
            /// </summary>
            /// <remarks>source: Wikipedia "Flinn-Engdahl regionalization"<br/><see href="https://en.wikipedia.org/wiki/Flinn-Engdahl_regionalization"/></remarks>
            public static readonly Dictionary<int, string> NameList_enUS = new Dictionary<int, string>
            {
                {   1, "Central Alaska" },
                {   2, "Southern Alaska" },
                {   3, "Bering Sea" },
